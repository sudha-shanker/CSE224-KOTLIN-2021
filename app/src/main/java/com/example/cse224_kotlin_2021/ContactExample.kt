...
import com.example.cse224_kotlin_2021.R

class ContactExample : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fButton = findViewById<com.google.android.material.floatingactionbutton.FloatingActionButton>(R.id.fab)
